...
**
** Created: Mon Feb 22 20:57:00 2010
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("freeze.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("openlock_small.png"), QSize(), QIcon::Normal, QIcon::On);
